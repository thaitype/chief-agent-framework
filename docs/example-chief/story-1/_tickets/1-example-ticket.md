...
.chief/story-N/_tickets/<seq>-<slug>.md (no story-number prefix - the folder already scopes
it). A wayfinder decision-ticket looks the same but
...
resolve. See docs/manual/reference/directory-structure.md and docs/design/v5-ai-workflow.md.
-->
