...
└── story-X/
    ├── _map.md          # Only if /chief-wayfinder was used — Destination/fog/decisions
    ├── _goal/           # Story goal + Out of Scope
    ├── _contract/       # Story contract + Testing Decisions
    ├── _tickets/         # Decision-tickets (from /chief-wayfinder) and implementation
    │                     # tickets (from /chief-plan), vertical slices with blocking edges
